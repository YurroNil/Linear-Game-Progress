...
advancement revoke @s only lgp:_functions/in_structure/ocean_ruins
advancement revoke @s only lgp:_functions/in_structure/monument
advancement revoke @s only lgp:_functions/in_biome/ocean
