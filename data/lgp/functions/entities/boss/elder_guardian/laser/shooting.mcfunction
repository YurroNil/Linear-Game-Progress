...
execute if score @s lgp.elderGuardian.bossType3 matches ..59 positioned ^ ^ ^0.3 unless entity @e[tag=player.group,tag=!player.operTags,distance=..1] run function lgp:entities/boss/elder_guardian/laser/shooting
