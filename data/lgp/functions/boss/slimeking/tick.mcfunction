#BOSS生成
    ...
    #生成史莱姆王
    execute at @e[tag=lgp.slimeKing.summonMarker] run function lgp:boss/slimeking/summon
    #初始化
...
#史莱姆王分身
    ...
    execute as @e[tag=lgp.slimeKing.tickTimer,scores={lgp.slimeKing=80..}] run function lgp:boss/slimeking/bekilled
...
#设置史莱姆王的生成CD为10天一周期
    ...
    execute if score #slimeKing.inCD.dayPeriod lgp.world matches 10.. run function lgp:boss/slimeking/cd_reset
