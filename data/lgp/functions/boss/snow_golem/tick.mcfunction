#雪球造成伤害
    #对玩家
    execute as @e[type=minecraft:snowball] at @s on origin if entity @s[type=minecraft:snow_golem,tag=lgp.snowGolem] run function lgp:boss/snow_golem/damage

#生命上限
    execute as @e[type=minecraft:snow_golem,tag=!lgp.snowGolem,tag=lgp.BOSS] run function lgp:boss/snow_golem/model
