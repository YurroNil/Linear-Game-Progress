...
advancement revoke @s only lgp:_functions/in_structure/mansion
advancement revoke @s only lgp:_functions/in_biome/dark_forest
advancement revoke @s only lgp:_functions/in_biome/caves
