...
tag @e[type=cave_spider,tag=!lgp.location.mobReplaced,predicate=lgp:locations/in_biome/lush_caves,predicate=!lgp:locations/in_biome/tech/caves/is_cave_areas] add lgp.location.mobReplaced
tag @e[type=skeleton,tag=!lgp.location.mobReplaced,predicate=lgp:locations/in_biome/lush_caves,predicate=!lgp:locations/in_biome/tech/caves/is_cave_areas] add lgp.location.mobReplaced